    ...
    render() {
        ...
        return (
            <div className={`compose-modal flex`}>
                ...
                <input type='email' name='email' placeholder='to:' onChange={this.handelChange}></input>
                <input type="text" name="subject" placeholder="Type subject here" onChange={this.handelChange}></input>
